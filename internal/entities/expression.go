...
func splitIntoSubexpressions(root *Node, subexpressionMap map[int]string) (string, error) {
...
func ConvertSubexpressionToAgentsTask(subexpression database.Subexpression) AgentsTask {
